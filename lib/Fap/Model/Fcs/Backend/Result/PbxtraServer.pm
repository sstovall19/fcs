package Fap::Model::Fcs::Backend::Result::PbxtraServer;
...
__PACKAGE__->table("pbxtra.server");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:ojg2YLW+esIyLfws/dK0tg
...
__PACKAGE__->might_have(
  "unbound_hosts",
  "Fap::Model::Fcs::Backend::Result::PbxtraUnboundHost",
  { "foreign.server_id" => "self.mosted" },
...
__PACKAGE__->might_have(
  "customer",
  "Fap::Model::Fcs::Backend::Result::PbxtraCustomer",
