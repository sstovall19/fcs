package Fap::Model::Fcs::Backend::Result::Product;
...
__PACKAGE__->add_unique_constraint("deployment_id", ["deployment_id"]);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:mPExQM6/0TypizX/dgzm+g
