package Fap::Model::Fcs::Backend::Result::BundleLicense;
...
__PACKAGE__->add_unique_constraint("bundle_id", ["bundle_id", "license_type_id"]);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:74qObMvvwtiDdDX7mN4O0Q
